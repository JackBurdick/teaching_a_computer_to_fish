...
\TD{Understanding Diffusion Models: A Unified Perspective~\cite{Luo2022UnderstandingDM}}

\TD{The Effects of Regularization and Data Augmentation are Class Dependent~\cite{Balestriero2022TheEO}}

\TD{Efficient Methods for Natural Language Processing: A Survey~\cite{Treviso2022EfficientMF}}

\TD{Normalized Activation Function: Toward Better Convergence~\cite{Peiwen2022NormalizedAF}}

% CNN
\TD{Visual Feature Extraction by a Multilayered Network of Analog Threshold Elements~\cite{Fukushima1969VisualFE}}
