...
% TODO: This could be an entire book itself. Important to get the right reviewers +citations
...
\TD{feedback loop --- positive feedback loop: the more the model is used, the more biased the data becomes}

\section{examples}

\TD{policing/crime prediction, youtube example}