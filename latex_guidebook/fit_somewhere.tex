...
% https://machinelearningmastery.com/cross-entropy-for-machine-learning/ says KL = calculat relative entropy between two
% x-entropy = calc total entropy between distributions
% TODO: read https://machinelearningmastery.com/cross-entropy-for-machine-learning/
\r{cross-entropy -- used to calculate the difference between two probability distributions, related to KL Divergence, but different. }
%%%%%%%%%%%%%%%%%%%%%
