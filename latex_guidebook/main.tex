...
%\part{ML Foundations}
%\chapter{overview}
%\chapter{ensembling methods}
%\section{regularization}
%\section{optimizers}


%%% how to use the pieces learned in the previous section to accomplish goals
%\part{Supervised}
%\chapter{Overview}
...
% TODO: drop (move parts to appendix) -- examples will use yeahml
\part{TensorFlow}
